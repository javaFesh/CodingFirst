...
<body>
<div>
    <center><h3>插入题目</h3></center>
    <form action="${pageContext.request.contextPath}/houtai/houtaiWritingAdd" method="post">
        ...
        <div class="form-group" style="align-content: center">
            ...
            <textarea class="form-control" id="editor_id" name="answer" cols="100" rows="17"
                      placeholder="请输入题目答案......"></textarea>

        </div>
        <div class="form-group">

            选择添加类型:<select name="typeId" id="" style="width: 102px; height: 35px">
        ...
        <div class="form-group">
            ...
            <input type="hidden" name="staticing" value="0">
