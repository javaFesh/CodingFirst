...
<div class="context" style="margin-top: 160px">
    <div class="context-tiku" style="margin-top: 200px">
        <c:forEach items="${meetConpanyList}" var="b" varStatus="s">

            <div class="context-pis">

                <p><a href="${pageContext.request.contextPath}/writing/findMeetingingByPage?id=${b.meetId}&currentPage=1">${b.conName}</a></p>
            </div>
        </c:forEach>
