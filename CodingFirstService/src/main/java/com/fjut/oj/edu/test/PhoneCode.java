...
public class PhoneCode {
    ...
    public static void main(String[] args) {
        String phone = "18750712658"; //此处可输入你的手机号码进行测试
        getPhonemsg(phone);
    ...
    public static String getPhonemsg(String mobile) {
        ...
        // 替换成你的AK
        final String accessKeyId = "LTAIaxFZJWxLZ09G";// 你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "j3sV3LjXaNVIXbR92epkm80shiPQr9";// 你的accessKeySecret，参考本文档步骤2
